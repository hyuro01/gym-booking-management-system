<template>
   <div class="app-container">
      ...
      <el-table v-loading="loading" :data="noticeList" @selection-change="handleSelectionChange">
         ...
         <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
            <template #default="scope">
               ...
               <el-button link type="info" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['system:notice:remove']" >删除</el-button>
            </template>
         </el-table-column>
      </el-table>
      ...
      <!-- 查看公告内容 -->
      <el-dialog v-model="dialogTableVisible" title="公告详情" width="400">
         <div v-html="selectedNotice.noticeContent"></div>
      </el-dialog>
...
const selectedNotice = ref({}); // 存储选中的公告信息

const openDialog = (notice) => {
  selectedNotice.value = notice; // 赋值选中的公告
